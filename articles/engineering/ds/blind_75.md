...
I have seen this in multiple platform people emphasizes too much on dynamic programming, where as my personal openion is to skip it until you get comfortable with Tree, Recursion and Grapth problems. Then if and when time permits do the Dynamic Programming questions from this list.
